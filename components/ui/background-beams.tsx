...
export const BackgroundBeams = React.memo(
  ({
    className,
    colors = "default", // "default" | "purple" | "green" | "red" | "rainbow"
    intensity = "medium", // "low" | "medium" | "high"
  }: {
    className?: string;
    colors?: "default" | "purple" | "green" | "red" | "rainbow";
    ...
    // تحديد الشفافية بناءً على الشدة
    const getOpacity = () => {
      switch (intensity) {
        case "low":
          return "0.2";
        ...
        >
          ...
          <defs>
            {paths.map((path, index) => (
              ...
              >
                <stop stopColor={colorStops.start} stopOpacity="0" />
                <stop stopColor={colorStops.start} />
                <stop offset="32.5%" stopColor={colorStops.middle} />
                <stop
                  offset="100%"
                  stopColor={colorStops.end}
                  stopOpacity="0"
                />
              </motion.linearGradient>
            ))}
